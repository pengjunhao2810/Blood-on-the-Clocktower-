...
/* ============ 游戏设置信息(酒鬼+干扰项) ============ */
.setup-info { background:linear-gradient(135deg,#1a1a2e,#0d0d1a); border:1px solid #2a2a4e; border-radius:8px; padding:8px 14px; margin-bottom:10px; font-size:12px; color:#aaa; display:none; }
.setup-info.show { display:block; }
